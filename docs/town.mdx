...
![Borderra geopolitical Minecraft town preview](../static/img/borderra-hero.avif)
...
1. Pick a location using the [Map Guide](./map.mdx). Check nearby claims, coastlines, roads, resources, and room for future growth.
