...
If you are new, start with [How to Join](./ip), read the [Rules](./rules), then open the [live map](https://map.borderra.com) once you are ready to choose where to settle.
...
- **Fair monetization goals** - Premium should support the server without selling territory, combat power, or direct economic shortcuts.
